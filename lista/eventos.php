...
<body>
    ...
    <div id="adicionar_panel" class="main-modal fixed w-full inset-0 z-50 overflow-hidden flex justify-center items-center hidden">
        <div class="modal_container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl z-50 overflow-y-auto">
                ...
                ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            <div class="text-sm">
                                <div class="font-medium text-gray-700"><?php echo $ideventos ?></div>
                            </div>
                        </th>
                        <td class="px-6 py-4"><?php echo $img ?></td>
                        <td class="px-6 py-4"><?php echo $nome ?></td>
                        <td class="px-6 py-4"><?php echo $valor ?></td>
                        <td class="px-6 py-4"><?php echo $descricao ?></td>
                        <td class="px-6 py-4"><?php echo $cadastro ?></td>
                        <td class="px-6 py-4">
