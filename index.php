  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul id="bar-navigation" class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
              <ul class="">
                <li class="nav-item">
                  <a href="#" id="cardapio" routes="cardapio" class="nav-link routes">
                    <p>Cardapio</p>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="#" id="Eventos" routes="eventos" class="nav-link routes">
                    <p>Eventos</p>
                  </a>
                </li>
              </ul>
